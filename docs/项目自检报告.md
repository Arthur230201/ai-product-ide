...
- **app/actions/node-operations.ts**: 8 处调用
...
- **components/canvas/DesignSystemReadOnlyPanel.tsx**: 3 处
...
- **app/actions/generate-graph.ts**: 5 处
...
```json
{
  "timestamp": "2026-03-18T10:13:13.783Z",
  "checks": {
    "build": {
      "status": "pass",
      "duration": 24644
        ...
        },
        {
          ...
          "matches": [
            ...
            },
            {
              "type": "getTextModel",
              "line": 120,
              "context": "del = hasImage ? getVisionModel(input.aiConfig) : getTextModel(input.aiConfig);\n    const userContent = buildNodeEditUserContent(userText, input.media"
            },
            {
              "type": "getTextModel",
              "line": 159,
    ...
    "jsonParseIssues": {
      ...
      "entries": [
        ...
        {
          "file": "components/canvas/DesignSystemReadOnlyPanel.tsx",
          "issues": [
            {
              "type": "JSON.stringify",
              "line": 246,
            ...
            },
            {
              ...
              "line": 389,
              "hasErrorHandling": true,
              "context": "           <button\n                  type=\"button\"\n                  onClick={() => copyToClipboard(JSON.stringify(snapshot, null, 2), '快照 JSON')}\n                  className=\"inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-100 text-xs font-"
            },
            {
              "type": "JSON.stringify",
              "line": 580,
              "hasErrorHandling": true,
              "context": "utton\n                      type=\"button\"\n                      onClick={() => void copyToClipboard(JSON.stringify(snapshotDiff, null, 2), ' diff JSON')}\n                      className=\"inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-xs transit"
            }
          ]
        },
        {
        ...
        {
          "file": "lib/design-system/__tests__/design-system-m3.test.ts",
          "issues": [
            {
              "type": "JSON.stringify",
              "line": 31,
        ...
        {
          "file": "lib/design-system/recommend-design-system.ts",
          "issues": [
            {
              "type": "JSON.parse",
              "line": 66,
              "hasErrorHandling": true,
              "context": "st end = body.lastIndexOf('}');\n  if (start === -1 || end <= start) return null;\n  try {\n    return JSON.parse(body.slice(start, end + 1));\n  } catch {\n    return null;\n  }\n}\n\nfunction toMarkdown(d: DesignSystemRecommend): string {\n  const kw = d.styleKeywords.length ? d.styleKeywords.join('、') : '—"
            }
          ]
        },
        {
          "file": "lib/design-system/ts-engine/uupm-data.ts",
          "issues": [
            {
              "type": "JSON.parse",
              "line": 331,
              "hasErrorHandling": false,
              "context": "industries,\n    productTypes,\n    patterns: uniq(patterns.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainPattern),\n    colorPalettes: uniq(palettes.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainPalette),\n    typographyProfiles: uniq(typographyProfiles.map((p) => "
            },
            {
              "type": "JSON.parse",
              "line": 332,
              "hasErrorHandling": false,
              "context": "se(s) as DomainPattern),\n    colorPalettes: uniq(palettes.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainPalette),\n    typographyProfiles: uniq(typographyProfiles.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainTypography),\n    effectsProfiles: uniq(effectsProfiles"
            },
            {
              "type": "JSON.parse",
              "line": 333,
              "hasErrorHandling": false,
              "context": "Palette),\n    typographyProfiles: uniq(typographyProfiles.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainTypography),\n    effectsProfiles: uniq(effectsProfiles.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainEffects),\n    antiPatterns: uniq(antiPatterns.map((p) => "
            },
            {
              "type": "JSON.parse",
              "line": 334,
              "hasErrorHandling": false,
              "context": "ainTypography),\n    effectsProfiles: uniq(effectsProfiles.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainEffects),\n    antiPatterns: uniq(antiPatterns.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainAvoid),\n    a11yRules: uniq(a11yRules.map((p) => JSON.stringify(p)"
            },
            {
              "type": "JSON.parse",
              "line": 335,
              "hasErrorHandling": false,
              "context": "s) as DomainEffects),\n    antiPatterns: uniq(antiPatterns.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainAvoid),\n    a11yRules: uniq(a11yRules.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainA11y),\n  };\n}\n\nfunction buildScaledStyles(domains: UupmTsEngineData['domai"
            },
            {
              "type": "JSON.parse",
              "line": 336,
              "hasErrorHandling": false,
              "context": "N.parse(s) as DomainAvoid),\n    a11yRules: uniq(a11yRules.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainA11y),\n  };\n}\n\nfunction buildScaledStyles(domains: UupmTsEngineData['domains'], anchors: StyleEntry[]): StyleEntry[] {\n  const industries = domains.industries;\n  const productTy"
            },
            {
              "type": "JSON.stringify",
              "line": 331,
              "hasErrorHandling": false,
              "context": "),\n    });\n  }\n\n  return {\n    industries,\n    productTypes,\n    patterns: uniq(patterns.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainPattern),\n    colorPalettes: uniq(palettes.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainPalette),\n    typographyProfiles: uniq"
            },
            {
              "type": "JSON.stringify",
              "line": 332,
              "hasErrorHandling": false,
              "context": "ingify(p))).map((s) => JSON.parse(s) as DomainPattern),\n    colorPalettes: uniq(palettes.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainPalette),\n    typographyProfiles: uniq(typographyProfiles.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainTypography),\n    effect"
            },
            {
              "type": "JSON.stringify",
              "line": 333,
              "hasErrorHandling": false,
              "context": "((s) => JSON.parse(s) as DomainPalette),\n    typographyProfiles: uniq(typographyProfiles.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainTypography),\n    effectsProfiles: uniq(effectsProfiles.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainEffects),\n    antiPatterns"
            },
            {
              "type": "JSON.stringify",
              "line": 334,
              "hasErrorHandling": false,
              "context": "map((s) => JSON.parse(s) as DomainTypography),\n    effectsProfiles: uniq(effectsProfiles.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainEffects),\n    antiPatterns: uniq(antiPatterns.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainAvoid),\n    a11yRules: uniq(a11yRul"
            },
            {
              "type": "JSON.stringify",
              "line": 335,
              "hasErrorHandling": false,
              "context": "ify(p))).map((s) => JSON.parse(s) as DomainEffects),\n    antiPatterns: uniq(antiPatterns.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainAvoid),\n    a11yRules: uniq(a11yRules.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainA11y),\n  };\n}\n\nfunction buildScaledStyles(d"
            },
            {
              "type": "JSON.stringify",
              "line": 336,
              "hasErrorHandling": false,
              "context": "N.stringify(p))).map((s) => JSON.parse(s) as DomainAvoid),\n    a11yRules: uniq(a11yRules.map((p) => JSON.stringify(p))).map((s) => JSON.parse(s) as DomainA11y),\n  };\n}\n\nfunction buildScaledStyles(domains: UupmTsEngineData['domains'], anchors: StyleEntry[]): StyleEntry[] {\n  const industries = domain"
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "issues": [
            ...
            },
            {
              ...
              "line": 1594,
              "hasErrorHandling": true,
              "context": "et: state.viewportPreset,\n        aiConfig: { ...state.aiConfig },\n        currentTheme: JSON.parse(JSON.stringify(state.currentTheme)) as UIThemeConfig,\n      };\n    } catch (error) {\n      console.error('Error in exportProject:', error);\n      return emptyV3ProjectExport();\n    }\n  },\n\n  // Theme "
            },
            {
              "type": "JSON.stringify",
              "line": 1854,
