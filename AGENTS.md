...
- **设计系统（总方案）**：[DESIGN_SYSTEM_MASTER_PLAN.md](docs/DESIGN_SYSTEM_MASTER_PLAN.md)（长期完整路线：Phase 1～5、数据模型、架构）  
- **设计系统 Phase 1**：[DESIGN_SYSTEM_AUTO_ROADMAP.md](docs/DESIGN_SYSTEM_AUTO_ROADMAP.md)（`stylePreset=auto`、已实现说明）  
- **设计系统专家审计与终版规格**：[DESIGN_SYSTEM_EXPERT_AUDIT_FINAL.md](docs/DESIGN_SYSTEM_EXPERT_AUDIT_FINAL.md)（五轮审计 + FR/NFR/接口/KPI，≥2 万字）  
- **设计系统开发约束（详设）**：[DESIGN_SYSTEM_DEV_CONSTRAINTS.md](docs/DESIGN_SYSTEM_DEV_CONSTRAINTS.md)（Store/注入顺序/导出契约/DoD/CR 清单）  
- **设计系统审计报告**：[DESIGN_SYSTEM_AUDIT_REPORT_2026-03.md](docs/DESIGN_SYSTEM_AUDIT_REPORT_2026-03.md)（文档与实现差异、优先级）
...
- **UI/UX**：[UI_UX_FULL_REDESIGN_10_ROUNDS.md](docs/UI_UX_FULL_REDESIGN_10_ROUNDS.md)、[UX_UI_REDESIGN_JOBS_VISION.md](docs/UX_UI_REDESIGN_JOBS_VISION.md)（乔布斯式整体方案 + Toast 规范）、[COMPONENT_LIBRARY_AND_PAGE_DESCRIPTION.md](docs/COMPONENT_LIBRARY_AND_PAGE_DESCRIPTION.md)
...
- **设计系统**：[ROADMAP_NEXT](docs/DESIGN_SYSTEM_ROADMAP_NEXT.md)、[下一冲刺](docs/DESIGN_SYSTEM_SPRINT_NEXT.md)、[TS 引擎](docs/DESIGN_SYSTEM_TS_ENGINE.md)、[UUPM](docs/DESIGN_SYSTEM_UUPM.md)、[E2E/校验](docs/DESIGN_SYSTEM_E2E.md)
- **UUPM 等价计划**：[UIUXPROMAX_PARITY_MASTER_PLAN.md](docs/UIUXPROMAX_PARITY_MASTER_PLAN.md)
